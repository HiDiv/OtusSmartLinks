...
class AfterOrEqualTimestampStrategyTest extends Unit
{
    ...
    protected function _before(): void
    {
        ...
        $this->sut = new AfterOrEqualTimestampStrategy($this->parserMock, $this->clockMock);
    }
}
